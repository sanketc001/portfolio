          ...
          <div className="space-y-4 text-xs md:text-sm">
            <div className="flex items-center gap-3 p-4 rounded-xl bg-slate-100/50 dark:bg-slate-900/30 border border-slate-200/20">
              ...
              <div>
                ...
                <a href={`mailto:${profile.email}`} className="text-slate-700 dark:text-slate-200 font-medium hover:text-violet-500 transition-colors">
                  {profile.email}
                </a>
              </div>
            </div>
              ...
              {status === 'success' ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-205 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold text-xs rounded-xl cursor-pointer"
                  >
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-slate-205 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-violet-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      disabled={status === 'submitting'}
                      className="w-full px-3.5 py-2.5 rounded-xl border border-slate-205 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-violet-500 resize-none"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={status === 'submitting'}
                    className="w-full flex items-center justify-center gap-1.5 py-3 bg-violet-600 hover:bg-violet-750 disabled:bg-violet-400 text-white font-bold rounded-xl transition-all cursor-pointer shadow-md"
                  >
                    {status === 'submitting' ? (
                      <span>Sending...</span>
                    ) : (
